...
public class UserServiceIMPL implements UserService {
	...
	public void addUserInService(User u) {
		if (u != null) {
			...
			sm.setSubject("User registration completed!!!");
			sm.setText("Hi welcome to User managment system... your username is : " + u.getUsername()
					+ " and password is : " + u.getUpassword());
	...
	@Override
	public User getAllDetailsUsingIdInService(int id) {
		User user = ur.findById(id).get();
		return user;
	}
